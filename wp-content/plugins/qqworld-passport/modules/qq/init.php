...
class qq extends core {
	...
	public function init() {
		...
		if ($this->is_activated($this->slug)) {
			...
			add_action( 'qqworld_passport_social_media_account_profile_form', array($this, 'profile_form') ); // ��������ҳ��ı�
...
<?php
	...
	public function parse_request() {
		...
		$code = $_GET['code'];
		$redirect_uri = urlencode($this->redirect_uri);
		// Step2��ͨ��Authorization Code��ȡRefresh Token
		...
		//Step3��ʹ��Refresh Token����ȡ�û���Access Token
		...
		//Step3��ʹ��Access Token����ȡ�û���OpenID
		...
		*/
		...
		if (get_option( 'users_can_register' )) {
			...
			if (isset($user_id) && $user_id) {
				// ��������������ܰ���'QQWorld Passport QQ Openid'���û������meta
